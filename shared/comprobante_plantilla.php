	...
	<table class="comprobante_head">
		<tr>
			...
			<td class="info_empresa">
				<div>
					<span class="h2">PUBLYSHER</span>
					<p>Av. Pastor Sevilla, Sector 6 grupo 4 Mz N Lt.12</p>
					<p>(alt. de Av. Juan Velazco) - Villa El Salvador - Lima</p>
					<p>Celular: 996 764 733</p>
					<p>Email: serviciotec.elias@gmail.com</p>
				</div>
			</td>
			<td class="info_comprobante">
				<div class="round">
					<span class="h3"><?php echo isset($comprobante["meta_data"]["ruc"])?"FACTURA":"BOLETA" ?></span>
					<p>No. Comprobante: <strong><?php echo $comprobante["meta_data"]["codigo"]?></strong></p>
					<p>Fecha: <?php echo $comprobante["meta_data"]["fecha"]?></p>
					<p>Hora: <?php echo date('h:i:s a', strtotime($comprobante["meta_data"]["hora"])) ?></p>
					<p><?php echo $comprobante["cajero"]?></p>
				</div>
			</td>
		</tr>
	</table>
