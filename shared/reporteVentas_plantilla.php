	...
	<table class="proforma_head">
		<tr>
			...
			<td class="info_proforma">
				<div class="round">
					<span class="h3">Reporte de Ventas</span>
					<p>Fecha: <?php echo $reporteVentas["fecha"]?></p>
					<p><?php echo $reporteVentas["vendedor"]?></p>
				</div>
			</td>
		</tr>
	</table>
    <h1 align="center" class="titulo">REPORTE DE VENTAS DEL DIA</h1>
    <br>
