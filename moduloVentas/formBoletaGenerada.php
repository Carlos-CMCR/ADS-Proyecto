            ...
            <div style="width:100%;">
                <table style="width:100%;" id="table_productos_lista">
                    ...
                    foreach ($datosProformaProductos as $dato){
                        ...
                        <td align="center"><input type="number" value="<?php echo $dato['cantidad'] ?>" min="1" max="<?php echo $dato['stock']?>"></td>
                        <td align="center"><input type="text" value="<?php echo $dato['precioProduct']?>" disabled></td>
                        <td align="center"><input type="text" value="<?php echo $dato['precioProduct']*$dato['cantidad'] ?>" disabled></td>
