...
class controllerRegistrarIncidencia{
    ...
    public function RegistrarIncidencia($fecha,$hora,$asunto,$descripcion){
        session_start();
        include_once("../model/Incidencia.php");
        $objIncidencia = new Incidencia;
        $resultado = $objIncidencia->insertarIncidencia($fecha,$hora,$asunto,$descripcion,$_SESSION["id_usuario"]);
